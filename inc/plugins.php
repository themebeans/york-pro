...
function york_register_required_plugins() {
	...
	$args = array(
		array(
			'name'     => esc_html__( 'Portfolio Post Type', 'york-pro' ),
			'slug'     => 'portfolio-post-type',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Simple Post Ordering', 'york-pro' ),
			'slug'     => 'simple-custom-post-order',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Contact Form 7', 'york-pro' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
	);
	 ...
	 */
	$config = array(
		'id'           => 'york-pro',          // Unique ID for hashing notices for multiple instances of TGMPA.
